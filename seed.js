...
const chapters = [
  ...
  // Melbourne South
  { name: 'BNI Royals Kingston', region: 'Melbourne South', day: 'Tuesday', time: '7:00 AM', venue: 'Parkdale Cricket Club', address: 'Gerry Green Reserve, Parkdale VIC 3195',
    members: [
      { name: 'Lachlan McDonald', email: 'design@neoretro.com.au', business: 'NeoRetro', category: 'Graphic Designer', phone: '0400 070 350' },
      { name: 'Simon Duncan', email: 'action@universal-osteopathy.com', business: 'Universal Osteopathy', category: 'Osteopath', phone: '0488 980 266' },
      { name: 'Marcus Auch-Schwelk', email: 'marcus@emberproperty.com.au', business: 'Ember Property', category: 'Property Management', phone: '0404 430 111' },
      { name: 'Anastasia Searle', email: 'anastasia@gobloom.com.au', business: 'GoBloom', category: 'Health & Wellness - Home Care Support', phone: '0407 733 064' },
      { name: 'Liam Gillespie', email: 'info@spark-life.com.au', business: 'Spark Life Electrical Contractors', category: 'Electrician - Residential', phone: '0434 343 687' },
      { name: 'Laura Sedgwick', email: 'hello@lsnutrition.com.au', business: 'LS Nutrition', category: 'Nutritionist', phone: '0437 681 814' },
      { name: 'Graham Don Paul', email: 'graham@reliantbi.com.au', business: 'Reliant Business Insurance', category: 'Business Insurance Broker', phone: '0492 333 953' },
      { name: 'Ange Sarailis', email: 'ange.sarailis@eview.com.au', business: 'Eview Real Estate', category: 'Residential Real Estate', phone: '0419 223 723' },
      { name: 'Kelly Jones', email: 'kelly@onetribemarketing.com.au', business: 'One Tribe Marketing', category: 'Marketing Consultant', phone: '0413 122 709' },
      { name: 'Trent Pirihi', email: 'trent@inner-athlete.com.au', business: 'Inner Athlete', category: 'Youth Athletic Development', phone: '0483 956 560' },
      { name: 'Kerrie Vivas', email: 'calicleanau@gmail.com', business: 'Cali Clean', category: 'Cleaning', phone: '0434 743 358' },
      { name: 'Michael Casaceli', email: 'mcgardening3195@outlook.com', business: 'MC Gardening', category: 'Lawn & Garden Professional', phone: '0484 324 727' },
      { name: 'Amy Bignell', email: 'amy@argentadvisory.com.au', business: 'Argent Advisory', category: 'General Accountant', phone: '0434 084 635' },
      { name: 'Lawrence Sukhu', email: 'lawrence@fitforpurposefinance.com.au', business: 'Fit for Purpose Finance', category: 'Commercial Loans', phone: '0415 835 479' },
      { name: 'Chris Mutimer', email: 'chris@excitehealthfitness.com.au', business: 'Excite Health & Fitness', category: 'Group Fitness Expert', phone: '0408 541 527' },
      { name: 'Josephine Raffaele', email: 'jskoblar@aplusconveyancing.com.au', business: 'A Plus Conveyancing VIC', category: 'Conveyancing', phone: '03 8740 3566' },
      { name: 'Benjamin Marriott', email: 'benjamin@cornerstoneandcompass.com', business: 'Cornerstone and Compass', category: 'Web Developer', phone: '0416 612 546' },
      { name: 'Molly Curd', email: 'info@plumblife.com.au', business: 'Plumblife', category: 'Plumbing', phone: '0411 442 316' },
      { name: 'Nick Comninacis', email: 'nick.comninacis@goldfinityfp.com.au', business: 'Goldfinity Financial Planning', category: 'Financial Adviser - Wealth and Superannuation', phone: '03 8521 0611' },
      { name: 'Kathryn Green', email: 'info@kathryngreen.org', business: 'Kathryn Green Coaching', category: 'Training & Coaching - Mindset & Wellbeing Coach', phone: '0402 761 301' },
      { name: 'Katrina Clark', email: 'katrina@arcadiabookkeeping.com.au', business: 'Arcadia Bookkeeping', category: 'Accounting Bookkeeping Service', phone: '0402 656 544' },
      { name: 'Tara Bonnitcha', email: 'tara@ifinances.com.au', business: 'iFinance Solutions', category: 'Residential Mortgage Broker', phone: '0439 808 111' },
      { name: 'Maurelio Gomes', email: 'maurelio@mgdatacomm.com.au', business: 'MG Datacomm', category: 'IT Support Services', phone: '0402 838 631' },
      { name: 'Sophie Dobson', email: 'sophie@realpropertypartners.com.au', business: 'Real Property Partners', category: 'Buyers Agent', phone: '0424 509 669' },
      { name: 'Liz Coluccio', email: 'hello@clearthread.com.au', business: 'Clearthread Communications', category: 'Copywriter', phone: '0438 210 017' },
    ]},
...
const tx = db.transaction(() => {
  chapters.forEach(ch => {
    ...
    ch.members.forEach((m, i) => {
      ...
      const email = m.email || `${emailBase}.${chapterId}@bni-member.com.au`;
